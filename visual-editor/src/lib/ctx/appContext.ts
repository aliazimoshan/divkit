...
import { ScreenModel } from '../components/models/ScreenModel';
...
export const systemScreens = derived(systemsList, ($systemsList, set) => {
  ...
  async function fetchScreens() {
    ...
    set(screens); // Update the derived store with fetched data
  }
