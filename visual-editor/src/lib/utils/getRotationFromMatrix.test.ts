...
describe('getRotationFromMatrix', () => {
  test('simple', () => {
    ...
    expect(getRotationFromMatrix('matrix(0, 1, -1, 0, 0, 0)')).toBeCloseTo(
      Math.PI / 2,
    );
    expect(
      getRotationFromMatrix(
    ...
    expect(getRotationFromMatrix('matrix(-1, 0, 0, -1, 0, 0)')).toBeCloseTo(
      Math.PI,
    );
    expect(
      getRotationFromMatrix(
