<script lang="ts">
  ...
  import {
    APP_CTX,
    type AppContext,
    type Background2DialogShowProps,
  } from '../../ctx/appContext';
  import type {
    Background,
    GradientBackground,
  ...
  function onPaletteChange(event: CustomEvent<string>): void {
    if (subtype === 'solid') {
      ...
      (value as GradientBackground).colors[selectedColorIndex] =
        paletteIdToValue(event.detail);
    }
  }
    ...
    <div class="background2-dialog__panels">
      {#if togglePalette}
        <div class="background2-dialog__panel background2-dialog__panel_left">
          <PaletteSelector bind:paletteId on:change={onPaletteChange} />
        </div>
      {/if}
      ...
      <div class="background2-dialog__panel">
        ...
        <div
          class="background2-dialog__content background2-dialog__content_{subtype}"
        >
          {#if value.type === 'solid'}
            <ColorSelect2
            ...
            {#if Array.isArray(value.colors)}
              <div class="background2-dialog__gradient-preview">
                <div class="background2-dialog__gradient-points">
                  ...
                  {#each value.colors as color, index}
                    ...
                    <div
                      ...
                      class:background2-dialog__gradient-point_selected={index ===
                        selectedColorIndex}
                    ...
                    >
                      ...
                      <ColorPreview
                        {color}
                        mix="background2-dialog__gradient-point-preview"
                      />
                    </div>
                  {/each}
                </div>
                ...
                <div class="background2-dialog__gradient-range">
                  ...
                  <div
                    ...
                    style:background-image="linear-gradient(to right, {value.colors
                      .map((color) =>
                        colorToCss(color, true, $previewThemeStore),
                      )
                      .join(', ')})"
                  ></div>
                </div>
              ...
              <div class="background2-dialog__split">
                <div class="background2-dialog__split-part">
                  ...
                  <label>
                    <div class="background2-dialog__label">
                      {$l10nString('props.background_gradient_angle')}
                    </div>
                    <Text
                      value={value.angle || 0}
                      subtype="angle"
                ...
                <div class="background2-dialog__split-part">
                  ...
                  <label>
                    <div class="background2-dialog__label">
                      {$l10nString('props.background_gradient_count')}
                    </div>
                    <Text
          ...
          {:else if value.type === 'image'}
            ...
            <div>
              <div class="background2-dialog__label">
                {$l10nString('props.content_alignment')}
              </div>
...
<style>
  ...
  :global(
    .background2-dialog__gradient-point-preview.background2-dialog__gradient-point-preview
  ) {
    position: absolute;
    top: 2px;
    right: 2px;
