...
>
  <div
    class="margins-paddings-prop__label margins-paddings-prop__label_margins"
  >
    {$l10n('props.margins')}
  </div>
  <div
    class="margins-paddings-prop__label margins-paddings-prop__label_paddings"
  >
    {$l10n('props.paddings')}
  </div>
  ...
  <div
    class="margins-paddings-prop__cell margins-paddings-prop__cell_input margins-paddings-prop__cell_center"
  >
    {$l10n('inset_content')}
  </div>
</div>
...
<style>
  ...
  .margins-paddings-prop:not(.margins-paddings-prop_disabled)
    .margins-paddings-prop__input:hover {
  ...
  .margins-paddings-prop_hover_paddings
    .margins-paddings-prop__cell_content-box {
    background-color: var(--fill-accent-2);
  }
