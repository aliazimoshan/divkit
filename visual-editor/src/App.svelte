<script lang="ts">
  ...
  import { showAddScreenModal } from './lib/ctx/appContext';
  import { onMount, getContext } from 'svelte';
  import { ScreenModel } from './lib/components/models/ScreenModel';
  import { SetJsonCommand } from './lib/data/commands/setJson';
  import YesNoModal from './lib/components/YesNoModal.svelte';
  import { isYesNoModalOpen, deletingScreen } from './lib/ctx/appContext';
